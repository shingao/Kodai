...
function fmtBpm(track) {
  if (!track?.bpm) return '---'
  return String(Math.round(track.bpm)).padStart(3, '0')
}

function fmtFormat(track) {
          ...
          <div className="player-info-inner">
            ...
            <div className="player-info-text">
              ...
              <div className="now-playing-codestrip">
                <span>BPM {fmtBpm(track)}</span>
                {fmtFormat(track) && <span>{fmtFormat(track)}</span>}
